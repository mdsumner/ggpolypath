...
[^3]: Winding vs. evenodd  [wikipedia figure](https://commons.wikimedia.org/wiki/File:Even-odd_and_non-zero_winding_fill_rules.svg). 
...
[^1]: TODO proper attribution and record of the `geom_polypath` function. 
